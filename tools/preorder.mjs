...
<style>
#preorder{box-sizing:border-box;position:relative;width:100vw;overflow-x:hidden;background:linear-gradient(rgba(9,23,7,.72),rgba(9,23,7,.82)),url(${BASE}assets/bg/overgrown-sphere-as470076105.webp) center/cover no-repeat fixed;padding-top:clamp(56px,6vw,90px);color:#fffffe;font-family:'Almarai',sans-serif;letter-spacing:.03em;padding-bottom:110px}
