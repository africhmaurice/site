...
#hp .hp-lb{position:absolute;right:12px;bottom:12px;width:13px;height:13px;border:0;padding:0;margin:0;background:#3b2470;cursor:default;
...
@media (max-width:560px){#hp .hp-lb{width:11px;height:11px;right:8px;bottom:8px}}
...
(function () {
  ...
  function render(p, crewTotal, board) {
    ...
    var lb = root.querySelector('.hp-lb'); if (!lb) { lb = document.createElement('button'); lb.className = 'hp-lb'; lb.type = 'button'; lb.setAttribute('aria-label', ' '); lb.tabIndex = -1; root.appendChild(lb); }
